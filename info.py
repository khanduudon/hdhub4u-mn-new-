...
PICS = (environ.get('PICS', 'https://graph.org/file/246a70cb4387b59cceb15-9e968f8602a6acb36c.jpg https://graph.org/file/c28c76a6c39bae7db9c3f-fcee36bb920105a77e.jpg https://graph.org/file/c28c76a6c39bae7db9c3f-fcee36bb920105a77e.jpg https://graph.org/file/246a70cb4387b59cceb15-9e968f8602a6acb36c.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8727689182').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004219114721').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004219114721'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1004219114721'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1004219114721'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1004219114721')  # Support group id (make sure bot is admin)
silent_group_id = environ.get('SILENT_GROUP_ID', '-1004219114721') # Silent group id
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1004219114721')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/hd_pro_support_group')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1004219114721")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1004219114721")# Channels for force sub (make sure bot is admin)
...
DATABASE_URI3 = environ.get('DATABASE_URI3', "")  # MongoDB URI for the third database (if MULTIPLE_DB is True)
DATABASE_URI4 = environ.get('DATABASE_URI4', "")  # MongoDB URI for the fourth database (if MULTIPLE_DB is True)
# ============================
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1004219114721')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1004219114721')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
if MULTIPLE_DB == False:
    ...
    DATABASE_URI3 = DATABASE_URI3
    DATABASE_URI4 = DATABASE_URI4
